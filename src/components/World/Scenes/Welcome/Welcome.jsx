...
import { Milk } from './Models/Decoration/Milk';
...
const Welcome = () => {
  ...
  const handleMilk = () => {
    milkRef.current.applyImpulse({ x: 0, y: 1, z: 0 }, true);
  };
  ...
  return (
    <>
      ...
      <Arrow
        ...
        scale={0.2}
      />
      {/* <Among position={[0,0,0]} /> */}
      <RigidBody
        ref={milkRef}
        // onClick={() => handleMilk()}
        colliders={'cuboid'}
        position={[-4, 1.5, 1]}
        rotation-y={toRadians(90)}
        scale={0.2}
      >
        <Milk handleMilk={handleMilk} />
      </RigidBody>
    </>
  );
};
